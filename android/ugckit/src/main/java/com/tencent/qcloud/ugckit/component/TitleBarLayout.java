...
public class TitleBarLayout extends LinearLayout implements ITitleBarLayout {
    ...
    public void setEnableRightButton(boolean enable) {
        ...
        if (enable){
            ...
            mRightButton.setBackground(getResources().getDrawable(R.drawable.bg_next_title));
            mRightButton.setTextColor(getResources().getColor(R.color.ugckit_text_color_disable));
        }
    }
