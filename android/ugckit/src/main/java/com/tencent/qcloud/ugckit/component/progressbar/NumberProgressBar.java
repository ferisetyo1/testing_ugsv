...
public class NumberProgressBar extends View {
    ...
    protected void onDraw(@NonNull Canvas canvas) {
        ...
        if (mDrawUnreachedBar) {
            canvas.drawRoundRect(mUnreachedRectF, mUnreachedBarHeight, mUnreachedBarHeight, mUnreachedBarPaint);
        }

        if (mDrawReachedBar) {
            canvas.drawRoundRect(mReachedRectF, mReachedBarHeight, mReachedBarHeight, mReachedBarPaint);
        }
    ...
    private void calculateDrawRectF() {
        ...
        if (getProgress() == 0) {
            ...
            mDrawTextStart = (mReachedRectF.right - mDrawTextWidth - dp2px(8));
        }
