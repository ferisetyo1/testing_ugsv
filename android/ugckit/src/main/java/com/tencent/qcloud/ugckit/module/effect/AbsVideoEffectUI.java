...
public abstract class AbsVideoEffectUI extends RelativeLayout implements IVideoEffectKit {
    ...
    public void hideTabs(){
        findViewById(R.id.line_effect).setVisibility(GONE);
        findViewById(R.id.tabs_effect).setVisibility(GONE);
    }
    public void showTabs(){
        findViewById(R.id.line_effect).setVisibility(VISIBLE);
        findViewById(R.id.tabs_effect).setVisibility(VISIBLE);
    }

    public TabLayout getTabLayout(){ return findViewById(R.id.tabs_effect); }
}
