 ...
 * 音效Pannel
 */
public class SoundEffectsPannel extends RelativeLayout implements ISoundEffectsPannel, SeekBar.OnSeekBarChangeListener, View.OnClickListener, TabLayout.OnTabSelectedListener {
...
//    private Button               mButtonReverb;
    ...
    private void init(Context context) {
        ...
        tabs = (TabLayout) findViewById(R.id.tabs_sound);
...
//        mButtonReverb.setOnClickListener(this);
        ...
        mButtonClose = findViewById(R.id.iv_close);
...
//        } else
        ...
        } else if (i == mButtonClose.getId()) {
            if (mSoundEffectsSettingPannelListener!=null && !mSoundEffectsSettingPannelListener.onCloseSuara()){
