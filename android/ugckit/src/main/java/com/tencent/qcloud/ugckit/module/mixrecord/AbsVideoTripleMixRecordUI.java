...
//        mScrollFilterView.setBeautyPanel(mBeautyPanel);
        getScrollFilterView().setPanelListener(new ScrollFilterView.OnPanelListener() {
            ...
            public int getFilterProgress(int index) {
                return mBeautyPanel.getFilterProgress(index);
            }

            @Override
            public Bitmap getFilterResource(int index) {
                return mBeautyPanel.getFilterResource(index);
            }

            @Override
            public int getFilterSize() {
                return mBeautyPanel.getFilterSize();
            }

            @Override
            public ItemInfo getFilterItemInfo(int index) {
                return mBeautyPanel.getFilterItemInfo(index);
            }
        });
