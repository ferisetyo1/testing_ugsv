...
public class RecordMusicPannel extends RelativeLayout implements IRecordMusicPannel, SeekBar.OnSeekBarChangeListener, RangeSlider.OnRangeChangeListener, View.OnClickListener {
    ...
    private void init(Context context) {
        ...
        mTextEndTime = (TextView) findViewById(R.id.tv_bgm_end_time);
        mTextStartTime.setText("00:00");
        mTextEndTime.setText("00:00");
    ...
    public void onKeyUp(int type, int leftPinIndex, int rightPinIndex) {
        ...
        mTextStartTime.setText(DateTimeUtil.millsecondToMinuteSecond((int) leftTime));
        mTextEndTime.setText(DateTimeUtil.millsecondToMinuteSecond((int) rightTime));
    }
    ...
    private void setCutRange(long startTime, long endTime) {
        ...
        if (mTextStartTime != null) {
            mTextStartTime.setText(DateTimeUtil.millsecondToMinuteSecond((int) startTime));
        }
        if (mTextEndTime != null) {
            mTextEndTime.setText(DateTimeUtil.millsecondToMinuteSecond((int) endTime));
        }
    }
    ...
    public void setMusicDeleteIconResource(int resid) {
        mImageDelete.setCompoundDrawablesWithIntrinsicBounds(0,resid,0,0);
    }

    @Override
    public void setMusicReplaceIconResource(int resid) {
        mImageReplace.setCompoundDrawablesWithIntrinsicBounds(0,resid,0,0);
    }
